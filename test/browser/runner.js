...
function initMocha (reporter) {
  ...
  function shimMochaInstance (m) {
    ...
    m.run = () => {
      const all = []; const pending = []; const failures = []; const passes = []
...
export const runner = function ({ file, reporter, timeout, width, height, args, executablePath, visible, polling }) {
